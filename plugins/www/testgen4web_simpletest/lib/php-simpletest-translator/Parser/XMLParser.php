<?php
     ...
     * PHP version 5
     * 
     * file name  : XMLParser.php
     * created    : Thu 29 Sep 2005 04:19:58 PM PDT
     * 
     * @category 
    ...
    * @package TestGen4Web_Parser
    */
    class TestGen4Web_Parser_XMLParser extends XML_Parser {
        /*{{{ Members */
        ...
        * @access public
        */
        protected function handleAttrTag($name, $attrs) {
            $tag = array();
        ...
        * @access public
        */
        public function startHandler($xp, $name, $attributes) {
            $this->openTags[] = $name;
        }
        ...
        */
        public function endHandler($xp, $name) {
            ...
            case "MESSAGE":
                if($lastTag == "ERROR") {
                    $this->_docroot["ERROR"]["MESSAGE"] = $this->getCData();
                }
                break;
            }
            // Empty CData
        ...
        * @access public
        */
        protected function getLastOpenTag($tag) {
