...
try {
    ...
    $attach_result_as = $parameters['db_check_tablespace_attach_result'];
    $filename         = $parameters['db_check_tablespace_file_name'];
    ...
    if (count($rows)>0) {
        ...
        $retention_data['retention'] = $parameters['db_check_tablespace_retention'];
