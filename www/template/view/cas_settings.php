...
/**
 * Frontend page allows to view the cas settings defined in Ortro
 *
 * PHP version 5
 *
...
i18n('template', 'configure_metadata_cas.php');
require ORTRO_CONF . 'configure_metadata_cas.php';
...
if (!include_once 'CAS.php') {
    showMessage('CAS client not found.', 'warning');
} else {
    @include ORTRO_CONF . 'configure_cas.php';
    //modify settings
    $intro            = 'Please set the fields below according to your environment.' . '<br/>';
    $table_open       = '';
    $table_close      = '';
    $f_hidden_install = '';
    $html             = '';
