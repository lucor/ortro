...
define('ORTRO_VERSION', '1.3.4');
define('ORTRO_DEFAULT_LANGUAGE', 'en');

define('DS', DIRECTORY_SEPARATOR);
define('ORTRO_PATH', '/usr/share/ortro/');

define('ORTRO_CONF', '/etc/ortro/');
...
define('ORTRO_DATA', '/var/lib/ortro/');
...
define('ORTRO_LIB', '/usr/share/php/ortro/');
define('ORTRO_LIB_PEAR', ORTRO_LIB . 'Pear' . DS);

define('ORTRO_LOG', '/var/log/ortro/');
...
define('ORTRO_TEMP', '/tmp/ortro/');

define('ORTRO_WEB', '/usr/share/ortro/www/');
...
if (file_exists(ORTRO_CONF . 'configure.php')) {
    include_once ORTRO_CONF . 'configure.php';
}
